        ...
        fetchData() {
            fetch('api/recruit')
                ...
                .then(res => {
                    ...
                    this.description = res.data.description_ua;
                    this.email = res.data.email;
                    this.employment_status = res.data.employment_status_ua;
                    this.location_text = res.data.location_text_ua;
                    this.benefits = res.data.benefits_ua;
                    this.workdays = res.data.workdays_ua;
                    this.field_positions_available = res.data.field_positions_available_ua;
                    this.field_job_description = res.data.field_job_description_ua;
                    this.field_employment_status = res.data.field_employment_status_ua;
                    this.field_location = res.data.field_location_ua;
                    this.field_benefits = res.data.field_benefits_ua;
                    this.field_workdays = res.data.field_workdays_ua;
                    this.field_recruiting_process = res.data.field_recruiting_process_ua;
                    this.field_recruiting_process_1 = res.data.field_recruiting_process_1_ua;
                    this.field_recruiting_process_2 = res.data.field_recruiting_process_2_ua;
                    this.field_recruiting_process_3 = res.data.field_recruiting_process_3_ua;
                    this.field_recruiting_process_4 = res.data.field_recruiting_process_4_ua;
                    this.field_bottom_text = res.data.field_bottom_text_ua;
                })
        },
    }
